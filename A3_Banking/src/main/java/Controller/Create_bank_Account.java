 ...
 Customer customer   =	(Customer) req.getSession().getAttribute("customer");
  ...
  //	bank_account.setAmount(0);
   ...
   customer.setBankacconts(list2);
	...
	resp.getWriter().print("<h1>Congratulations your account_has created successfully wait for manager Approval</h1>");
	 req.getRequestDispatcher("Home.html").include(req, resp);
  }
  else
  {
		 resp.getWriter().print("<h1>Already_account_is existed</h1>");
